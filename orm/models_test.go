...
type Post struct {
	...
	Updated time.Time `orm:"auto_now"`
	Tags    []*Tag    `orm:"rel(m2m);rel_through(github.com/epiqm/beego/orm.PostTags)"`
}
...
type Permission struct {
	ID     int `orm:"column(id)"`
	Name   string
	Groups []*Group `orm:"rel(m2m);rel_through(github.com/epiqm/beego/orm.GroupPermissions)"`
}
...
go get -u github.com/epiqm/beego/orm
...
go test -v github.com/epiqm/beego/orm
